...
def main():
    ...
    while validation:
        ...
        if start == "1":
            insert_student()  #call insert student
        elif start == "2":
            insert_admin()  #call insert admin
        elif start == "3":
            insert_course()  #call insert course
        elif start == "4":
            student_list()
        elif start == "5":
            admin_list()  #call all admins
        elif start == "6":
            course_list() #call all courses
        elif start == "7":
            validation = False
